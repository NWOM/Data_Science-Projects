...
#Blueprint allows us to group routes together 
...
@require_auth
def analytics(): #to see how many times a certain url is opened and some type of authentication 
...
def page_not_found(e):
	return '<h1>Page nehe mila</h1>',404
